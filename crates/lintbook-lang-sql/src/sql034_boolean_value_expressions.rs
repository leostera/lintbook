    ...
    fn check_boolean_comparisons(
        ...
        for (line_idx, line) in lines.iter().enumerate() {
            ...
            let patterns = [
                (
                    "= true",
                    "Remove '= TRUE', use the boolean expression directly",
                ),
                (
                    "=true",
                    "Remove '=TRUE', use the boolean expression directly",
                ...
                (
                    "!= false",
                    "Remove '!= FALSE', use the boolean expression directly",
                ),
                (
                    "!=false",
                    "Remove '!=FALSE', use the boolean expression directly",
                ...
                (
                    "is true",
                    "Remove 'IS TRUE', use the boolean expression directly",
                ),
                (
                    "is false",
                    "Replace 'IS FALSE' with 'NOT' or check for NULL values if needed",
                ),
                (
                    "is not true",
                    "Replace 'IS NOT TRUE' with 'NOT' or check for NULL values if needed",
                ),
                (
                    "is not false",
                    "Remove 'IS NOT FALSE', use the boolean expression directly or check for NULL",
                ),
            ];
