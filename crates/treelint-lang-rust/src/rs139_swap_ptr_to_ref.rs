...
fn has_mixed_ptr_ref_types(call_text: &str) -> bool {
    ...
    let has_ptr = call_text.contains("*mut") || call_text.contains("*const") || call_text.contains("as_ptr");
    let has_ref = call_text.contains("&mut") || call_text.contains("&") && !call_text.contains("&mut");
