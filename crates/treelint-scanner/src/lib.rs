...
use treelint_lang::{get_grammars_for_extensions, Grammar, lints::LintViolation};
...
impl Scanner {
    ...
    pub fn scan_and_lint_files(repo_root: &Path, config: &treelint_config::TreelintConfig) -> Result<Vec<LintResult>> {
