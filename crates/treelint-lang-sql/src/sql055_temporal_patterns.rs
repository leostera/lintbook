...
impl TemporalPatterns {
    ...
    fn check_datetime_types(
        ...
        if lower_line.contains("create table") || lower_line.contains("alter table") {
            ...
            if (lower_line.contains("date") || lower_line.contains("time")) && lower_line.contains("varchar") {
                let start_pos = node.start_position();
                violations.push(LintViolation {
                    line: start_pos.row + line_idx + 1,
                    column: start_pos.column + 1,
    ...
    fn check_date_arithmetic(
        ...
        if lower_line.contains("concat") && (lower_line.contains("year") || lower_line.contains("month") || lower_line.contains("day")) {
            let start_pos = node.start_position();
            violations.push(LintViolation {
                line: start_pos.row + line_idx + 1,
                column: start_pos.column + 1,
        ...
        if lower_line.contains("february") && lower_line.contains("29") {
            ...
            violations.push(LintViolation {
                line: start_pos.row + line_idx + 1,
                column: start_pos.column + 1,
                message: "Hardcoded February 29th. Ensure leap year handling is correct".to_string(),
                lint_name: self.name().to_string(),
                lint_id: self.id().to_string(),
            });
        }
    ...
    fn check_date_formatting(
        ...
        if lower_line.contains("format(") && (lower_line.contains("date") || lower_line.contains("time")) {
            let start_pos = node.start_position();
            violations.push(LintViolation {
                line: start_pos.row + line_idx + 1,
                column: start_pos.column + 1,
    ...
    fn check_temporal_ranges(
        ...
        if lower_line.contains(" where ") && (lower_line.contains("year(") || lower_line.contains("month(") || lower_line.contains("day(")) {
            let start_pos = node.start_position();
            violations.push(LintViolation {
                line: start_pos.row + line_idx + 1,
                column: start_pos.column + 1,
        ...
        if lower_line.contains(" between ") && (lower_line.contains("date") || lower_line.contains("time")) {
