...
impl QueryComplexity {
    ...
    fn check_join_count(
        ...
        let join_patterns = [" join ", " inner join ", " left join ", " right join ", " outer join ", " cross join "];
    ...
    fn check_union_complexity(
        ...
        let union_count = lower_line.matches(" union ").count() + lower_line.matches(" union all ").count();
