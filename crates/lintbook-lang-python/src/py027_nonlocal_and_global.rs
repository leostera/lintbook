...
impl NonlocalAndGlobal {
    ...
    fn collect_declarations<'a>(
        ...
        node: Node<'a>,
        source: &str,
        global_vars: &mut HashMap<String, Node<'a>>,
        nonlocal_vars: &mut HashMap<String, Node<'a>>,
    ) {
        match node.kind() {
            "global_statement" => {
    ...
    fn collect_global_variables<'a>(
        &self,
        global_statement: Node<'a>,
        source: &str,
        global_vars: &mut HashMap<String, Node<'a>>,
    ) {
    ...
    fn collect_nonlocal_variables<'a>(
        &self,
        nonlocal_statement: Node<'a>,
        source: &str,
        nonlocal_vars: &mut HashMap<String, Node<'a>>,
    ) {
