...
impl UnsafeExec {
    ...
    fn contains_suspicious_patterns(&self, args_text: &str) -> bool {
        ...
        suspicious_patterns
            .iter()
            .any(|&pattern| args_text.contains(pattern))
    }
    ...
    fn looks_like_user_input(&self, var_name: &str) -> bool {
        ...
        user_input_indicators
            .iter()
            .any(|&indicator| var_lower.contains(indicator))
    }
...
defmodule Example do
  def test(user_command) do
    ...
    System.shell(user_command)
        ...
        assert!(violations
            .iter()
            .any(|v| v.message.contains("System.shell")));
...
defmodule Example do
  def test(user_command) do
    ...
    :erlang.open_port({:spawn, user_command}, [])
        ...
        assert!(violations
            .iter()
            .any(|v| v.message.contains(":erlang.open_port")));
    }
}
